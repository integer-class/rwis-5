    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <a href="{{ route('warga.profile', Auth::user()->nik) }}" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> Data Diri
                </a>
                <a href="{{ route('warga.family', Auth::user()->nik) }}" class="dropdown-item has-icon">

                    <i class="fa-solid fa-people-group"></i> Data Keluarga
                </a>
