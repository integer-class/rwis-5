    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Edit Informasi</div>
            </div>
        </div>
        <form action="{{ route('information.update', $information->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="section-body">
                ...
                <h2 class="section-title">Edit Informasi</h2>
                <p class="section-lead">Kamu bisa mengubah data seputar informasi tentang kegiatan yang akan
                    dilaksanakan</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="activity" value="{{ $information->title }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" data-height="150" name="desc" required>{{ old('desc', $information->desc) }}</textarea>
                                ...
                                <div class="form-group">
                                    <label>Tanggal</label>
                                    <input type="date" class="form-control" name="date" value="{{ $information->date }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6 col-lg-6">
                                            <input type="time" class="form-control" class="time" name="time1" value="{{ $time1 }}" required>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6">
                                            <input type="time" class="form-control" class="time" name="time2" value="{{ $time2 }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="place" value="{{ $information->place }}" required>
