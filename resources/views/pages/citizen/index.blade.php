        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-button">
                    <a href="{{ url('citizen/create') }}" class="btn btn-primary">Add New</a>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ url('citizen/index') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href='{{-- {{ route('citizen.edit', $citizens->nik) }} --}}'
                                                            class="btn btn-sm btn-info btn-icon">
                                                            <i class="fas fa-edit"></i>
                                                            Edit
                                                        </a>

                                                        <form action="{{-- {{ route('citizen.destroy', $citizens->nik) }} --}}" method="POST"
                                                            class="ml-2">
